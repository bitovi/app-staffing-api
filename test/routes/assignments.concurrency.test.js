...
describe('Overlapping assignments are prevented while multiple records are inserted at the same time', function () {
  ...
  test.concurrent.each(
    [
      ...
      ['insert is successful, should return 201', dates.endAfterAssignmentDate, dates.afterEndDate, 201],
      ['overlap detected, should return 409', dates.endAfterAssignmentDate, dates.afterEndDate, 409]
...
describe('Overlapping assignments are prevented while multiple records are updated concurrently', function () {
  ...
  test.concurrent.each(
    [
      ...
      ['patch is successful, should return 200', dates.endDate, dates.afterEndDate, 200],
      ['overlap detected, should return 409', dates.startDate, dates.endDate, 409]
