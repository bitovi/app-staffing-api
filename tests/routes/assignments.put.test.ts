...
describe("PUT /api/assignments/:id", () => {
  ...
  it("should update optional end_date to null", async () => {
    const { Assignment, Employee, Project, Role } = global.model
  ...
  it("should return 200 for payload dates out of range of role, assignment dates before roles and start date is not confident", async () => {
    const { Assignment, Employee, Project, Role } = global.model
